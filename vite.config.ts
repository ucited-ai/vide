...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-vide/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "eslint/no-restricted-imports": [
        "error",
        {
          paths: [
            {
              name: "@vide/client-runtime",
              message:
                "Import from an explicit @vide/client-runtime/* subpath. The package has no root export.",
            },
          ],
        },
      ],
      "vide/no-global-process-runtime": "error",
      "vide/no-inline-schema-compile": "warn",
      "vide/no-manual-effect-runtime-in-tests": "error",
      "vide/namespace-node-imports": "error",
    },
    options: {
