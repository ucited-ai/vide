  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const tempIndexPath = path.join(
        gitCommonDir,
        `vide-checkpoint-index-${NodeCrypto.randomUUID()}`,
      );
      const commitEnv: NodeJS.ProcessEnv = {
        ...process.env,
        GIT_INDEX_FILE: tempIndexPath,
        GIT_AUTHOR_NAME: "Vide",
        GIT_AUTHOR_EMAIL: "vide@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Vide",
        GIT_COMMITTER_EMAIL: "vide@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `vide checkpoint ref=${input.checkpointRef}`;
