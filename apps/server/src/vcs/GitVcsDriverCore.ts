...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@vide/shared/git";
import { compactTraceAttributes } from "@vide/shared/observability";
import { decodeJsonResult } from "@vide/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `vide-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
