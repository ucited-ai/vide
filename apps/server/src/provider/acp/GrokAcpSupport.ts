import { type GrokSettings, ProviderDriverKind } from "@vide/contracts";
...
import { normalizeModelSlug } from "@vide/shared/model";
...
const VIDE_OAUTH_REFERRER = "videcode";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: VIDE_OAUTH_REFERRER,
    },
  };
}
