import { tokenizeCliArgs } from "@vide/shared/cliArgs";

export const VIDE_CODEX_LAUNCH_ARGS_ENV = "VIDE_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[VIDE_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
