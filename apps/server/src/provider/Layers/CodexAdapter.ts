          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  Vide_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.vide.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.vide.bearer_token_env_var="Vide_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
