...
import { type CursorSettings, type ModelSelection } from "@vide/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@vide/shared/git";
import { extractJsonObject } from "@vide/shared/schemaJson";
  ...
  const runCursorJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeCursorAcpRuntime({
        ...
        cwd,
        clientInfo: { name: "vide-git-text", version: "0.0.0" },
