...
import { type DeepPartial, deepMerge } from "@vide/shared/Struct";
import { fromJsonStringPretty, fromLenientJson } from "@vide/shared/schemaJson";
import {
  applyServerSettingsPatch,
  isModelSelectionProviderEnabled,
} from "@vide/shared/serverSettings";
import * as ServerSecretStore from "./auth/ServerSecretStore.ts";

export { resolveSourceControlWriterModelSelection } from "@vide/shared/serverSettings";
...
>()("vide/serverSettings/ServerSettingsService") {
