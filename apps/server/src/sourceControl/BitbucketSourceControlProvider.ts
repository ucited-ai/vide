...
import { SourceControlProviderError, type ChangeRequest } from "@vide/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set VIDE_BITBUCKET_EMAIL and VIDE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
