 ...
 *
 * The scan reads the provider CLIs' own session files rather than Vide's
 * orchestration projections, so usage covers turns driven outside Vide too.
