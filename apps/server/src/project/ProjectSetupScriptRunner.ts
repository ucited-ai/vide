import { ProjectId } from "@vide/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@vide/shared/projectScripts";
...
>()("vide/project/ProjectSetupScriptRunner") {}
