...
const PIERRE_ICON_SPRITE_ID = "vide-pierre-file-icon-sprite";

const Vide_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="vide-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="vide-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="vide-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="vide-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="vide-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="vide-file-icon-pnpm" viewBox="0 0 32 32">
...
export const Vide_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: Vide_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "vide-file-icon-package-json",
    "tsconfig.json": "vide-file-icon-tsconfig",
    "agents.md": "vide-file-icon-agents",
    "claude.md": "vide-file-icon-claude",
    "readme.md": "vide-file-icon-readme",
    "pnpm-lock.yaml": "vide-file-icon-pnpm",
    "pnpm-workspace.yaml": "vide-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(Vide_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${Vide_FILE_ICON_SPRITE}`;
