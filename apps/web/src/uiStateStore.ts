...
export const PERSISTED_STATE_KEY = "vide:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "vide:renderer-state:v8",
  "vide:renderer-state:v7",
  "vide:renderer-state:v6",
  "vide:renderer-state:v5",
  "vide:renderer-state:v4",
  "vide:renderer-state:v3",
