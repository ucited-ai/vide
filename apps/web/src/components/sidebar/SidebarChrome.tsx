...
/**
 * The V from assets/brand/vide-mark.svg, drawn monochrome so it inherits the
 * surrounding text colour. Geometry is identical to the app icon's mark, just
 * cropped to the glyph's own bounds instead of the icon canvas.
 */
function VideWordmark() {
  return (
    <svg
      aria-label="Vide"
