...
import type { RelayClientInstallProgressStage } from "@vide/contracts";
    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "Vide is preparing this environment for secure access through Vide Connect."
              : "Vide needs the relay client to make this environment available through Vide Connect."}
          </DialogDescription>
        </DialogHeader>
