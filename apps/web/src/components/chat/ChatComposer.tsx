...
import { createModelSelection, normalizeModelSlug } from "@vide/shared/model";
import {
  memo,
  type ReactNode,
  useCallback,
...
import type { UnifiedSettings } from "@vide/contracts/settings";
          ...
          {showCollapsedMobilePromptRow ? (
            <div className="flex items-center justify-between gap-2 px-3 py-2">
              <button
                type="button"
                className={cn(
                  "min-w-0 flex-1 truncate bg-transparent p-0 text-left text-(length:--text-chat) focus:outline-none",
