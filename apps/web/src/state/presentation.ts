...
import type { EnvironmentPresentation } from "@vide/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@vide/client-runtime/state/presentation";
