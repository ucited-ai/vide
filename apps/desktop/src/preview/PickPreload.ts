...
const OVERLAY_ATTRIBUTE = "data-vide-annotation-ui";
const Z_INDEX_OVERLAY = 2147483646;
const PRIMARY = "var(--vide-primary)";
const PRIMARY_FILL = "color-mix(in srgb, var(--vide-primary) 10%, transparent)";
...
const applyAnnotationTheme = (
  ...
  const variables = {
    "--vide-radius": theme.radius,
    "--vide-background": theme.background,
    "--vide-foreground": theme.foreground,
    "--vide-popover": theme.popover,
    "--vide-popover-foreground": theme.popoverForeground,
    "--vide-primary": theme.primary,
    "--vide-primary-foreground": theme.primaryForeground,
    "--vide-muted": theme.muted,
    "--vide-muted-foreground": theme.mutedForeground,
    "--vide-accent": theme.accent,
    "--vide-accent-foreground": theme.accentForeground,
    "--vide-border": theme.border,
    "--vide-input": theme.input,
    "--vide-ring": theme.ring,
    "--vide-font-sans": theme.fontSans,
    "--vide-font-mono": theme.fontMono,
  };
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-vide-annotation-tool", tool);
  };
      ...
      if (isUsableRect(rect)) {
        ...
        if (found === 0) {
          ...
          const regionBox = createBox(
            PRIMARY,
            "color-mix(in srgb, var(--vide-primary) 6%, transparent)",
          );
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-vide-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
