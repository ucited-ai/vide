...
import { resolveRemoteVideCliPackageSpec } from "@vide/ssh/command";
import type { RemoteVideRunnerOptions } from "@vide/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteVideRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteVideServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteVideCliPackageSpec({
