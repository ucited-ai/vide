...
const rule = createOxlintRuleHarness("vide/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("vide/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("vide/no-manual-effect-runtime-in-tests");
