...
export const RELAY_LINK_PROOF_TYP = "vide-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "vide-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "vide-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "vide-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "vide-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "vide-env-activity+jwt";
