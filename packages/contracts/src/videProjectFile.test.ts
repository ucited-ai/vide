...
import { VideProjectFile } from "./videProjectFile.ts";

const decode = Schema.decodeUnknownSync(VideProjectFile);

describe("VideProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://vide.local/schema/vide.json",
