...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@vide/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "vide-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "vide-relay-dpop-access+jwt";
