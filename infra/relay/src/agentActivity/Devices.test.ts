import type { RelayDeviceRegistrationRequest } from "@vide/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.vide.app.preview" as RelayDeviceRegistrationRequest["bundleId"],
