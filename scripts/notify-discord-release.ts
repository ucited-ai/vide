  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Vide prerelease is available for nightly testers."
          : "A new Vide latest release is available.",
...
).pipe(Command.withDescription("Post a Vide release announcement to Discord."));
